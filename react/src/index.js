...
import NF from './components/Notification/Notification';
import Questwithtag from './components/Display/TagsQuestion/TagsQuestion'
...
ReactDOM.render(
    <BrowserRouter>
        <div>
            ...
            <Route path="/Notification" component={NF} exact />
            ...
            <Route path="/Quetag/:tagname" component={Questwithtag} exact />
        </div>
