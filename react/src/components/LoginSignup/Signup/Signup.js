...
class Signup extends Component {
    ...
    state = {
        ...
        Interest: [],
        AOS: [],
        interestsugg: ['programming', 'c++', 'c', 'java', 'python', 'ios', 'android', 'mysql', 'django'],
        specializationsugg: ['Javascript', 'reactjs', 'nodejs', 'json', 'django'],
    ...
    handleSubmit = () => {
        this.Auth.fetch(this.state.apiurl+'signup', {
                        ...
                        <div className="SSecond">
                            <div className="Signupdiv">
                                ...
                                <div className="Sformdiv">
                                    <form>
                                        <div>
                                            <span style={{ float: 'left' }} className="DeSpan">First Name:</span>
                                        ...
                                        <div>
                                            <span style={{ float: 'left' }} className="DeSpan">Last Name:</span>
                                        ...
                                        <div>
                                            <span style={{ float: 'left' }} className="DeSpan">Interest:</span>
                                            <span style={{ 'color': 'red', float: 'left', fontSize: 16 }}>{this.state.formErrors.interest}</span>
                                            <input type="text" name="Interest" list="interestsugg" placeholder="c++, c, java, .............." onChange={this.handleChangearr} required /><br /><br />
                                            <datalist id="interestsugg" >
                                                {this.state.interestsugg.map(k =>
                                        ...
                                        <div>
                                            <span style={{ float: 'left' }} className="DeSpan1">Area of Specialization:</span>
                                            <span style={{ 'color': 'red', float: 'left', fontSize: 16 }}>{this.state.formErrors.AOS}</span>
                                            <input type="text" name='AOS' list="specializationsugg" placeholder="javascript, nodejs, ..............." onChange={this.handleChangearr} required /><br /><br />
                                            <datalist id="specializationsugg" >
                                                {this.state.specializationsugg.map(k =>
                                                    <option key={k} value={k} />
                                                )}
                                            </datalist>
                                        </div>
                                        <Button type="submit" onClick={this.handleSubmit} variant="primary" className="Sformbutton" disabled={!this.state.formValid2}><NavLink to="/" className="SNA">Save Profile</NavLink></Button>
                                        <br /><br />
                                    </form>
                                </div>
