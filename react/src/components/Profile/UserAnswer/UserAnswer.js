...
class UserAnswer extends Component {
    ...
    componentDidMount() {
        ...
        this.Auth.fetch(this.state.apiurl+'viewownanswer', {
            ...
            .catch(err => {
                // console.log('view own answer error', err)
            })
    ...
    deleteans = (ansid) => {
        ...
        this.Auth.fetch(this.state.apiurl+'deleteanswer', {
            method: 'POST', body: JSON.stringify({
                aid: ansid
            })
        }).then(res => {
                    ...
                    <div className="Ansdiv">
                        <div className="ansp">
                            ...
                            <div className="ans">
                                ...
                                <Button variant="outline-primary" className="ANSB UADB" onClick={() => this.deletepop(prooa._id)}>Delete Answer</Button>
                                {this.state.alert}
                            </div><br />
